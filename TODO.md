...
* [x] Полность автоматическая настройка
    ...
    - [v] Отдельная страница для автонастройки
    - [v] Контроллер автонастройки
      - [v] пробую убирать точки сначала если обнаружена нестабильность
      - [v] История измененний для каждого резонатора, чтобы отлавливать неверные измерения и потом мозможно предсказывать изменения.
      - [v] Статистика автонастройки

* [v] Добавить на страницу настроек возможность править насройки
    - [v] Шаблон HTML
    - [v] Событие JS
    - [v] Отправка на сервер
    - [v] Сохранение JSON
